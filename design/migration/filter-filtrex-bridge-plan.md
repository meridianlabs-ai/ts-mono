...
- [ ] **Step 1: Drive the real app** (dev server on 5173 — see `apps/inspect/.agents/skills/verify-log-viewer/SKILL.md`). Open a single-log samples page (e.g. `#/tasks/petri3_claude-opus-4-7__target-claude-opus-4-7.eval`) and verify:
