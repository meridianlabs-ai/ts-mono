...
export type HeadlineMetric = S["HeadlineMetric"];
...
export type FindMessagesRequest = S["FindMessagesRequest"];
export type FindMessagesProjection = S["FindMessagesProjection"];
export type FindMessagesResponse = S["FindMessagesResponse"];
export type FindMessagesRow = S["FindMessagesRow"];
