 ...
 * embedded in the log file name so the default Completed-descending sort
 * slots them by recency — a just-started eval surfaces at the top — instead
 * of coercing the missing date to epoch 0 and sinking them to the bottom.
 * Matches origin/main's default ordering, whose unsorted listing arrived
 * file-name-timestamp descending.
 */
